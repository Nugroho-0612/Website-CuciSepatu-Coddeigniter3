...
<div class="content-wrapper">
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h4 class="card-title"><a href="<?=base_url('Manage_gallery')?>" class="btn btn-secondary"
                                    tabindex="-1" role="button" aria-disabled="true">Manage</a></h4>
                        </div>
                        <div class="card-body">
    ...
    foreach ($gallery as $row) {
        ...
        ?>
                                ...
                                <div class="col-xl-2 col-md-6 portfolio-item filter-app">
                                    <div class="portfolio-wrap">
                                        <a href="<?php echo $imageURL; ?>" data-gallery="<?php echo $row["title"]; ?>"
                                            class="glightbox"><img src="<?php echo $imageURL; ?>" class="img-fluid"
                                                alt=""></a>
