    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <div class=" d-flex flex-row-reverse mb-2 me-5">
                ...
                <!-- Modal -->
                <form method="post" action="<?=base_url('Admin/addServices');?>" enctype="multipart/form-data">
                        ...
                        <div class="modal-dialog">
                            <div class=" modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">Jenis/Category</label>
                                        <select class="form-select" aria-label="Default select example"
                                            name="jenis/category">
                                            <option selected>Open this select menu</option>
                                            <option value="1">1. Clean Starters</option>
                                            <option value="2">2. Repaint</option>
                                            <option value="3">3. Bag & Cap Treatment
                                            </option>
                                        </select>
                                    </div>
                                    <div class="mb-3">
            ...
            <?php if (!empty($services)) {$i = 0;
    foreach ($services as $s) {$i++;
        ?>
            <tr>
                <td><?=$i;?></td>
                <td><?=$s['name'];?></td>
                <td><?=$s['name_jenis'];?></td>
                <td><?=$s['title'];?></td>
                <td><img src="<?=base_url('assets/img/services/') . $s['image'];?>" class="img-thumbnail"
                ...
                <td>
                                ...
                                <div class="modal-body">
                                    <div class="col-lg-4 col-md-6">
                                        ...
                                        <div class="card" style="width: 18rem;">
                                            <img src="<?=base_url('assets/img/services/') . $s['image'];?>"
                    ...
                    <!-- Modal -->
                    <form enctype="multipart/form-data" action="<?=base_url('Admin/editItemServices');?>" method="POST">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" aria-label="Default select example"
                                                name="jenis/category">
                                                <option selected><?php echo $s['jenis_id']; ?>
                                                </option>
                                                <option value="1">1. Clean Starters</option>
                                                <option value="2">2. Repaint</option>
                                                <option value="3">3. Bag & Cap Treatment
                    ...
                    <a href="<?php echo base_url('Admin/deleteItemServices/' . $s['id']); ?>"
