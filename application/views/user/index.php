...
<head>
    ...
    <link href="a<?php echo base_url() ?>assets/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">
        ...
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    <li>
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuAvatar">
                                <li>
                                    <a class="dropdown-item active disable"><?=$user['first_name'];?>&nbsp<?=$user['last_name'];?>
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a class="dropdown-item" href="<?=base_url('User/edit')?>">Settings</a>
                                </li>
                                <li>
                    ...
                    <li><a href="<?=base_url('User/checkout');?>"><i class="fas fa-shopping-cart"></i></a></li>
        ...
        <div class="container position-relative">
            <div class="row gy-5" data-aos="fade-in">
                ...
                <div class="col-lg-6 order-1 order-lg-2">
                    <img src="<?=base_url('assets/img/cuci_sepatu-removebg.png');?>" class="img-fluid" alt=""
                ...
                <div class="row gy-4" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="card" style="width: 18rem;">
                            <img src="assets/img/testi.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                    ...
                    <div class="col-lg-4 col-md-6" style="width:300px">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="<?=base_url('User/checkout');?>" class="btn btn-primary">Buy</a>
                            </div>
                        </div>
                    </div><!-- End Shop Item -->
                    <?php }?>
